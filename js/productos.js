...
const Productos = [
  ...
  new Producto(5, "Pasta de Aceitunas", "Almacen", 3240,"pastaaceituna.jpeg", "san nicolas"),
  new Producto(6, "Pure de Tomate" , "Almacen", 4830, "puretomate.jpg", "san nicolas"),
  new Producto(7, "Te en hebras 50G", "Almacen", 3150, "tes.jpg", "Masale"),
  new Producto(8, "Cepillo de dientes", "Cosmetica", 3000, "cepillo.png", "el alquimiartesanal"),
  ...
  new Producto(14, "Banana Formosa 1kg", "fruta", 1870, "bananas.png","",),
